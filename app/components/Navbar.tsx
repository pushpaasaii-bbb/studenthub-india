...
const NAV_LINKS = [
  {
    ...
    dropdown: [
      ...
      { label: 'IIITs', href: '/colleges?type=IIIT' },
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: 'Engineering Exams', href: '/exams?category=Engineering' },
      { label: 'Medical Exams', href: '/exams?category=Medical' },
      { label: 'Government Exams', href: '/exams?category=Government Jobs' },
      { label: 'Banking Exams', href: '/exams?category=Banking' },
      { label: 'Railway Exams', href: '/exams?category=Railway' },
      { label: 'Defence Exams', href: '/exams?category=Defense' },
      { label: 'Law Exams', href: '/exams?category=Law' },
      { label: 'International Exams', href: '/exams?category=International' },
    ],
  },
  {
  label: 'Jobs',
  href: '/jobs-v2',
    icon: Briefcase,
    dropdown: [
{ label: 'All Jobs', href: '/jobs-v2' },
      { label: 'A–Z Career Directory', href: '/jobs/a-z' },
      { label: 'Government Jobs', href: '/jobs?type=Central Government' },
      { label: 'IT Jobs', href: '/jobs?type=IT' },
      { label: 'Banking Jobs', href: '/jobs?type=Banking' },
      { label: 'Railway Jobs', href: '/jobs?type=Railways' },
      { label: 'Defence Jobs', href: '/jobs?type=Defence' },
    ],
  },
  {
    label: 'Tools',
    ...
    dropdown: [
      ...
      { label: 'Career Recommendation', href: '/tools/career-recommendation' },
  ...
  },
  {
    ...
    dropdown: [
      ...
      { label: 'Government Scholarships', href: '/scholarships?category=Central Government' },
      { label: 'Engineering Scholarships', href: '/scholarships?category=Engineering' },
      { label: 'Medical Scholarships', href: '/scholarships?category=Medical' },
      { label: 'Fellowships', href: '/scholarships?category=Fellowship' },
    ],
  },
]
